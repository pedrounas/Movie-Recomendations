...
Começamos por fazer uma amostra dos dados, que contêm os id's dos utlizadores, os nomes dos filmes e o rating que deram a um determinado filme. 
...
O género do utilizador tambem é um factor que podemos ter em conta. 
